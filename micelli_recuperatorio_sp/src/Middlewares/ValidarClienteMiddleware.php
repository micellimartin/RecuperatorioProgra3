    ...
    public function __invoke(Request $request, RequestHandler $handler): Response
    {
        ...
        if($tokenRecibido == true)
        {
            ...
            if(ValidarAdminMiddleware::validarTokenJWT($token))
            {
                ...
                if($usuario_decodificado->tipo == "cliente")
                {
                ...
                else
                {
                    ...
                    $response->getBody()->write(json_encode("Solo un cliente puede registrar un turno"));
                }
            }
            else
            {
        ...
        {
            $response->withStatus(403);
            $response->getBody()->write(json_encode("Para registrar un turno debe enviar token con tipo cliente por headers"));
        }
